...
public class StickyScrollView extends ScrollView {
    ...
    private IOnScrollToTop mOnScrollToTop = null;
    ...
    public interface IOnScrollToTop {
    ...
    private void doTheStickyThing() {
        ...
        for (View v : stickyViews) {
            int viewTop = getTopForViewRelativeOnlyChild(v) - getScrollY() + (clippingToPadding ? 0 : getPaddingTop()) - MIN_STICK_TOP;// add 50dp
        ...
        if (viewThatShouldStick != null) {
            stickyViewTopOffset = approachingView == null ? MIN_STICK_TOP : Math.min(MIN_STICK_TOP, getTopForViewRelativeOnlyChild(approachingView) - getScrollY() + (clippingToPadding ? 0 : getPaddingTop()) - viewThatShouldStick.getHeight());
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 查看数据
                LogcatUtil.d("curx:" + curX + ",cury:" + curY + ",xlast:" + xLast + ",ylast:" + yLast);
