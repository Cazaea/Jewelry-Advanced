package com.hxd.jewelry.demo2.config;

/**
 * 用于配置EventBus的事件
 *
 * @author Cazaea
 * @time 2017/icon_home_11/3 14:48
...
public class EventConfig {
     ...
     * 跳转页面处理
     */
    public static String EVENT_GO_TO_VERIFICATION_ACTIVITY = "EVENT_GO_TO_VERIFICATION_ACTIVITY";
