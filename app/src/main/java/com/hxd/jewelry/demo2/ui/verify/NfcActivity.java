package com.hxd.jewelry.demo2.ui.verify;
...
import com.hxd.jewelry.demo2.utils.NfcVUtil;
import com.hxd.jewelry.demo2.utils.ScreenUtil;
        ...
        if (nfcv != null) {
            ...
            if (intent.getAction().trim().equals("android.nfc.action.TECH_DISCOVERED")) {
                try {
                    ...
                    String result_UID = mNfcVUtil.getUID_MT();// e08100000105a25a
                    ...
                    if (isContinue) {
                        ...
                        // 启用网络签到
//                        runTask(result_UID);
//                        ToastUtil.showLongToast(this, "数据1==>" + result_UID + "数据2==>" + mNfcVUtil.getUID() + "数据3==>" + mNfcVUtil.getAFI() + "数据4==>" + mNfcVUtil.getDSFID());
//                        LogcatUtil.d( "数据1==>" + result_UID + "数据2==>" + mNfcVUtil.getUID() + "数据3==>" + mNfcVUtil.getAFI() + "数据4==>" + mNfcVUtil.getDSFID());

                    }
//                    Toast.makeText(SignNFCActivity.this,result_UID,Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
