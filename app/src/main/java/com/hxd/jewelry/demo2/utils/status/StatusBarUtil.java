package com.hxd.jewelry.demo2.utils.status;
...
/**
 * 操作状态栏的工具类
 * 设置StatusBar Mode的Api只在Android6.0之后版本中使用
 * 同时可适配MIUI6.0之后版本，FLYME4.0之后版本
 *
 * @author Cazaea
 * @time 2018/4/icon_home_10 icon_home_11:56
 * @mail wistorm@sina.com
 * GitHub: https://github.com/cazaea
 */
public class StatusBarUtil {
     ...
     * 为 fragment 头部是 ImageView 的设置状态栏透明
     *
     * @param activity       fragment 对应的 activityF
     * @param needOffsetView 需要向下偏移的 View
     */
